        ...
        <div className="w-full px-10 py-14">
          <div className="md:flex md:items-start md:justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="mt-5 max-w-sm text-base text-gray-300">
                Premium, reliable, and hassle-free car rentals tailored for your
                journey.
              </p>
            </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-base text-gray-300 sm:text-center">
