        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="text-center">
            <div className="relative inline-block mb-4">
              ...
              <FaCheckCircle className="absolute -top-2 -right-2 text-2xl text-orange-600 bg-white rounded-full" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              <span className="text-orange-600">01.</span> Choose & Book
            </h3>
          ...
          <div className="text-center">
            <div className="relative inline-block mb-4">
              ...
              <FaCheckCircle className="absolute -top-2 right-0 text-2xl text-orange-600 bg-white rounded-full" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              <span className="text-orange-600">02.</span> Confirm & Pay
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="text-center">
            <div className="relative inline-block mb-4">
              ...
              <div className="absolute top-2 left-1/2 transform -translate-x-1/2 -translate-y-1">
                <FaCar className="text-base text-orange-600" />
              </div>
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              <span className="text-orange-600">03.</span> Pick Up & Go
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed">
